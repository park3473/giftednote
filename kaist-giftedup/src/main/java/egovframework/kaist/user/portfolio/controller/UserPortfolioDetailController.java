...
public class UserPortfolioDetailController {
	...
	public ModelAndView view(HttpServletRequest request, HttpServletResponse response, @PathVariable("idx") String idx) {
		...
		portfolioModel = userPortfolioService.getView(idx);
	...
	public ModelAndView updateGet(@PathVariable("idx") String idx, HttpServletRequest request, HttpServletResponse response) {
		...
		model = userPortfolioService.getView(idx);
	...
	public String deletePost(@ModelAttribute("UserPortfolioVo") UserPortfolioVo userPortfolioVo, HttpServletRequest request,
		...
		ModelMap model = new ModelMap();
		model = userPortfolioService.getView(userPortfolioVo.getIDX());
	...
	public ModelAndView pdf(HttpServletRequest request, HttpServletResponse response, @PathVariable("idx") String idx) {
	...
	public ModelAndView insertGet(@PathVariable("portfolioid") String portfolioid, HttpServletRequest request, HttpServletResponse response) {

		ModelMap model = new ModelMap();
		
		UserMemberVo userMemberVo = new UserMemberVo();
		userMemberVo.setMEMBER_ID(portfolioid);
		ModelMap memberModel = userMemberService.getView(userMemberVo.getMEMBER_ID());
