...
public class UserMemberController {
	...
	public void loginPost(@ModelAttribute("UserMemberVo") UserMemberVo userMemberVo, 
		...
		}else if (userMemberPageDomain.getMEMBER_ID().equals(userMemberVo.getMEMBER_ID())) 
		{
			...
			if (pwd.equals(userMemberPageDomain.getPASSWORD())) {
				
				if(userMemberPageDomain.getLEVEL().equals("1") || true)
				{
	...
	public void smsLogin(@ModelAttribute("UserMemberVo") UserMemberVo userMemberVo, 
		...
		}else if (userMemberPageDomain.getMEMBER_ID().equals(userMemberVo.getMEMBER_ID()) && userMemberPageDomain.getPHONE().equals(userMemberVo.getPHONE()) && cerNumber != null) 
		{
			...
			if (cerNumber.equals(smsAuth)) {
		        ...
		        session2.setAttribute("ssion_login", "okok");
		        session2.setAttribute("ssion_user_ip", ip);
		        session2.setAttribute("ssion_user_id", member_id);
		        session2.setAttribute("ssion_name", NAME);
		        session2.setAttribute("ssion_level", LEVEL);
		        session2.setAttribute("ssion_user", userMemberPageDomain);
				
		        session2.setAttribute("ssion_member_type", TYPE);
				
				
				
				
		        session2.setAttribute("session_login_tm", SUtil.getNowTime());
		        session2.setAttribute("session_login_date", SUtil.getNowDate());
