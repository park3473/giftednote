                            ...
                            <div class="table_wrap">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/user/portfolio/detail/${item.MEMBER_ID}/list.do" target=_black">${item.MEMBER_ID}</a></td>
                                        <td><a href="/user/portfolio/detail/${item.MEMBER_ID}/list.do" target=_black">${item.NAME}</a></td>
