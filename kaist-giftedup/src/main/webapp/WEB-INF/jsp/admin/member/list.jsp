                                            ...
                                            <div class="form_01">
                                                ...
                                                <div class="page_seach">
                                                    <select ID="LEVEL" NAME="LEVEL">
                                                        ...
                                                        <option value="9" <c:if test="${model.beforeDomain.LEVEL == '9'}">selected</c:if>>대표멘토교사</option>
                                                        ...
                                                        <!-- <option value="5" <c:if test="${model.beforeDomain.LEVEL == '5'}">selected</c:if>>기타</option> -->
                                                    </select>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${item.TYPE == '2'}">${item.SCHOOL_JIGGEUB}</c:if>
                                        </td>
                                        <td>
                                            <c:if test="${item.TYPE == '1'}">학생</c:if>
                                            <c:if test="${item.TYPE == '2'}">교사</c:if>
                                        </td>
