											...
											<tbody id="list">
												...
												<tr class="update_modal">
												    ...
												    <td id="idx_${Status.index+1 }" style="display:none">
												     ...
												     <td class="tg-0lax" id="record_${Status.index+1 }"><button type="button" onclick="location.href='${pageContext.request.contextPath}/exploring/exploring.do?lab_id=${item.std_selected_lab_id }&IDX=${item.ur_id }'">탐구일지</button></td>
												 </tr>
												 </c:forEach>
											</tbody>
										</table>
