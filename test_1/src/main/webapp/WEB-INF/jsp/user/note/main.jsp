...
*/	
	function detail(idx){
		const element = document.getElementById(idx+'_detail');
		  ...
		  $('#detail_wrap').show();
		  $('#detail_wrap_bt').attr('onclick','location.href="/note/detail.do?lab_id='+idx+'&user_idx='+${session_idx}+'"');
		  $('#view_wrap_bt').attr('onclick','location.href="/user/note/view.do?lab_id='+idx+'&user_idx='+${session_idx}+'"');
