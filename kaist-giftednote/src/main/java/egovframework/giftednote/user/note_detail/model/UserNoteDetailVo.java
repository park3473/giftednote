package egovframework.giftednote.user.note_detail.model;

public class UserNoteDetailVo {
	...
	public String getP_USER_IDX() {
		return P_USER_IDX;
	}
	public void setP_USER_IDX(String p_USER_IDX) {
		P_USER_IDX = p_USER_IDX;
	}
	public String getP_CREATE_TM() {
		return P_CREATE_TM;
	}
	public void setP_CREATE_TM(String p_CREATE_TM) {
		P_CREATE_TM = p_CREATE_TM;
	}
	public String getP_UPDATE_TM() {
		return P_UPDATE_TM;
	}
	public void setP_UPDATE_TM(String p_UPDATE_TM) {
		P_UPDATE_TM = p_UPDATE_TM;
	}
