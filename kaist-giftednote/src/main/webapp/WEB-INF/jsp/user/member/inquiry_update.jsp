							                                ...
							                                <tr>
							                                    ...
							                                    <td colspan="3">
							                                        <div class="input_size input_size_full">
							                                            <input type="text" id="TITLE" name="TITLE" value="${model.view.TITLE }">
							                                        </div>
							                                    </td>
							                                </tr>
							                                <tr>
							                                    ...
							                                    <td colspan="3">
							                                        <div class="sort_select">
							                                            <div class="sort_textarea">
							                                                <textarea id="content" value="${model.view.CONTENT}">${model.view.CONTENT }</textarea>
							                                            </div>
							                                        </div>
							                                    </td>
							                                </tr>
...
*/
	...
	$('.submit_btn').click(function(){
		...
		$.ajax({
			type : "POST",
			url : "/user/member/inquiry_update.do",
			cache : false,
			data : ({
				I_IDX : I_IDX,
	            IDX : IDX,
