                        ...
                        <ul class="main_menu">
                            ...
                            <li class="main_menu_ob main_menu_ob_01 
                            	<c:if test="${
                            				...
                            				|| fn:indexOf(requestURI,'/record/') > -1
                            				|| fn:indexOf(requestURI,'/srce/') > -1
                            				|| fn:indexOf(requestURI,'/exploring/') > -1
                            				}">menu_active</c:if> ">
                                <a onclick="location.href='${pageContext.request.contextPath}/admin/team/note_list.do'"></a>
                            ...
                            <li class="main_menu_ob main_menu_ob_02 
                                ...
                                <a onclick="location.href='${pageContext.request.contextPath}/admin/member/list.do?ur_level=2'"></a>
                                <div class="sub_menu_con">
                                    <div class="sub_menu_title">
                                        <h2>회원 관리</h2>
                                    </div>
                                    <ul class="sub_menu_box">
                                        <li class="sub_menu_ob">
                                            <a href="${pageContext.request.contextPath }/admin/member/list.do?ur_level=2">학생 관리</a>
                                        </li>
                                        <li class="sub_menu_ob">
                                            <a href="${pageContext.request.contextPath }/admin/member/list.do?ur_level=3">지도자 관리</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
